...
<div class="hotel-section"><div class="container"><section class="panel">
  ...
  <div class="table-responsive"><table class="hotel-table">
    ...
    <tr><th>Check-in</th><td>${invoice.checkInDate}</td></tr>
    <tr><th>Check-out</th><td>${invoice.checkOutDate}</td></tr>
    <tr><th>Nights</th><td>${invoice.nights}</td></tr>
    <tr><th>Room Price</th><td><fmt:formatNumber value="${invoice.roomPricePerNight}" type="currency" currencySymbol="VND "/></td></tr>
