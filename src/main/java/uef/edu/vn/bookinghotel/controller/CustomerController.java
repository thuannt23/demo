...
public class CustomerController {
    ...
    public String profile(HttpSession session, Model model) {
        ...
        model.addAttribute(
                "bookings",
                customer.getId() == 0 ? Collections.emptyList() : bookingService.bookingsOf(customer.getId()));
        model.addAttribute(
                "invoices",
                customer.getId() == 0 ? Collections.emptyList() : invoiceService.invoicesOf(customer.getId()));
