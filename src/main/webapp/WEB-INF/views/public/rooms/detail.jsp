...
<div class="hero-lite"><div class="container"><h1>Room Details</h1><p>View room information before booking.</p></div></div>
<div class="hotel-section"><div class="container"><section class="panel">
  <div class="row">
    ...
    <div class="col-md-7">
      ...
      <p><strong>Price:</strong> <fmt:formatNumber value="${room.pricePerNight}" type="currency" currencySymbol="VND "/> per night</p>
      <p><strong>Status:</strong> <span class="badge-status">${room.status}</span></p>
      <p><strong>Description:</strong> ${room.description}</p>
      <a class="boxed-btn3 small" href="${pageContext.request.contextPath}/booking/search">Search Available Rooms</a>
    </div>
  </div>
</section></div></div>
