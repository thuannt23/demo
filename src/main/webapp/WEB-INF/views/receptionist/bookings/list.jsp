...
<div class="hotel-section">
  <div class="container">
    ...
    <c:if test="${sessionScope.currentUser.role == 'RECEPTIONIST' || sessionScope.currentUser.role == 'ADMIN'}">
    <section class="panel">
      <div class="panel-header"><div><h2 class="section-title"><i class="fa fa-edit"></i><span>Update Booking</span></h2><p class="muted-copy">Update booking dates by entering the booking ID.</p></div></div>
      <form method="post" action="${pageContext.request.contextPath}/bookings/update" class="hotel-form">
        <div class="row">
          ...
          <div class="col-md-4"><label>Check-in Date</label><input type="date" name="checkIn" required></div>
          <div class="col-md-4"><label>Check-out Date</label><input type="date" name="checkOut" required></div>
